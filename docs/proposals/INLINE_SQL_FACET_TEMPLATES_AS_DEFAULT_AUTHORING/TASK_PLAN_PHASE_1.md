...
- [ ] validate allowed placeholders against the declared contract type
- [ ] validate `template_key` usage for retained result-shape facets
- [ ] define failure cases for missing anchors, unsupported placeholders, and inconsistent contract metadata
