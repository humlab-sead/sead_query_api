...
- [ ] Select and probe the next routed target-only discrete live slice after `species_author:species_author`, then continue inventorying the remaining target-only targets once that result is known.
