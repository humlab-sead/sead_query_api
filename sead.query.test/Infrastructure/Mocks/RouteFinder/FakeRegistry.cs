...
internal static class FakeRegistryFactory
{
    ...
    public static Mock<RepositoryRegistry> MockRepositoryRegistry(List<Table> nodes, IEnumerable<TableRelation> edges, List<FacetTable> aliases)
    {
