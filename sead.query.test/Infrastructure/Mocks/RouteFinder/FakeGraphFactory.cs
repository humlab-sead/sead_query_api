...
public static class FakeGraphFactory
{
    ...
    public static Dictionary<char, Dictionary<char, int>> EdgesAsDictionary()
    {
        return new Dictionary<char, Dictionary<char, int>>
        {
            ...
            {
                'B',
                new Dictionary<char, int>() { { 'A', 7 }, { 'F', 2 } }
            },
            {
                'C',
            ...
            {
                'D',
                new Dictionary<char, int>() { { 'F', 8 } }
            },
            {
                'E',
                new Dictionary<char, int>() { { 'H', 1 } }
            },
            {
                'F',
                new Dictionary<char, int>()
            ...
            {
                'G',
                new Dictionary<char, int>() { { 'C', 4 }, { 'F', 9 } }
            },
            {
                'H',
                new Dictionary<char, int>() { { 'E', 1 }, { 'F', 3 } }
            },
        };
    }
    ...
    public static List<Table> FakeNodes(List<string> nodeNames) =>
        nodeNames
            .Select(
                (x, i) =>
                    new Table
    ...
    public static List<TableRelation> FakeRoute(List<(string, string, int)> uniedges, List<Table> nodes) =>
        uniedges
            .Select(
                (x, i) =>
                    new TableRelation
                    {
                        ...
                        SourceColumnName = x.Item1.ToLower(),
