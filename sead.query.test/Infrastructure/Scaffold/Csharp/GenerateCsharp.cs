...
namespace SQT.Scaffolding.Csharp
{
    ...
    public class GenerateCSharp(SeadJsonFacetContextFixture fixture) : MockerWithJsonFacetContext(fixture)
    {
        ...
        {
            var scaffolder = new MockerWithJsonFacetContext(Fixture);
